...
let ReportsController = class ReportsController {
    ...
    getSales(period = 'today') {
        return this.reportsService.getSalesReport(period);
    }
    getTopMenus(limit, period = 'month') {
...
__decorate([
    (0, common_1.Get)('top-menus'),
    __param(0, (0, common_1.Query)('limit')),
    __param(1, (0, common_1.Query)('period')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, String]),
    __metadata("design:returntype", void 0)
], ReportsController.prototype, "getTopMenus", null);
__decorate([
    (0, common_1.Get)('tables'),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", void 0)
], ReportsController.prototype, "getTableStats", null);
